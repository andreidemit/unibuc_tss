...
| Black-box tests | `tests/test_manual_basic.py`, `tests/test_ai_generated.py`, `tests/test_random.py` | Indeplinit | Acopera clase valide si invalide. |
| Partitionare de echivalenta | `README.md`, sectiunea Black-box testing | Indeplinit | Sunt documentate partitiile principale. |
| Valori de frontiera | `tests/test_mutation_killers.py` | Indeplinit | Include `0`, valori negative si valori pozitive foarte mici. |
| White-box tests | `tests/test_ai_generated.py`, `tests/test_mutation_killers.py` | Indeplinit | Sunt acoperite ramurile `express`, `same_day`, `premium`, `rural` si validarile. |
...
| Sistem identificare puncte critice | `src/test_prioritizer.py` | Indeplinit | Analizeaza AST si identifica validari, formule, decizii si output. |
